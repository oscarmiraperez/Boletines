...
export default function TechnicalForms() {
    ...
    const inputClasses = "mt-1 block w-full rounded-lg border border-slate-700 bg-slate-900/50 text-slate-200 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm px-3 py-2";
